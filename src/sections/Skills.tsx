    ...
    >
      ...
      <div className="w-[97%] max-w-384 mx-auto bg-background min-h-screen relative flex flex-col">
        ...
        <div className="w-full z-20 px-6 sm:px-8 lg:px-16 pt-10 sm:pt-14 relative">
          <header className="border-b border-dashed border-border pb-6 sm:pb-8 flex flex-col md:flex-row justify-between items-start md:items-end gap-4">
            <div>
            ...
            <div className="flex flex-col items-end gap-2 text-right">
              <p className="max-w-sm text-sm md:text-base pb-1 text-muted-foreground">
