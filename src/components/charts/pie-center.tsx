...
export interface PieCenterProps {
  ...
  suffix?: string;
  /** Custom value to show when not hovering. If not provided, shows total of all slices. */
  displayValue?: number;
}
...
export function PieCenter({
  ...
  const displayValue = hoveredData ? hoveredData.value : (displayValueProp !== undefined ? displayValueProp : totalValue);
