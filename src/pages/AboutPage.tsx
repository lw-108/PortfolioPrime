          ...
          <div className="flex justify-between items-center mb-8 w-[85%] absolute lg:top-4 md:top-0 sm:-top-2 -top-3 z-10">
            ...
            <div className="flex gap-4">
              ...
              <motion.a
                ...
                aria-label="GitHub"
                className="md:w-8 md:h-8 sm:w-7 w-6 sm:h-7 h-6 border border-neutral-700 bg-background/60 backdrop-blur-sm flex items-center justify-center text-muted-foreground hover:text-foreground hover:border-[#f54900] transition-colors cursor-pointer"
              >
