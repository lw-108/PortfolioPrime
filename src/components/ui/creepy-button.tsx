...
export const CreepyButton = ({
    ...
    return (
        <button
            className={cn(
                "relative min-w-[9em] rounded-none bg-black cursor-pointer outline-none select-none group tap-highlight-transparent",
        ...
        >
            ...
            <motion.span
                className={cn(
                    "absolute inset-0 block rounded-none bg-[#f54900] text-black font-bold tracking-wider",
