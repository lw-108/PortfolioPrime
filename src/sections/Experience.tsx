...
const experiencesData: ExperienceItemType[] = [
  {
    id: 'pitowings',
...
export const Experience: React.FC = () => {
  ...
  return (
    <section id="experience" className="relative z-10 w-full bg-transparent pt-0 pb-0 px-0 overflow-hidden select-none">
      <div className="w-[97%] max-w-384 mx-auto bg-background flex flex-col justify-between relative px-4 sm:px-8 lg:px-12 py-12">
        ...
        >
          ...
          <SliderContent className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-start">
            ...
            <div className="lg:col-span-6 flex flex-col justify-between backdrop-blur-md bg-neutral-100/40 dark:bg-neutral-950/20 border border-neutral-200/50 dark:border-neutral-800/50 p-6 sm:p-8 rounded-none shadow-sm">
              {experiencesData.map((exp) => (
                <SliderWrapper key={exp.id} value={exp.id} className="w-full h-full flex flex-col justify-between space-y-6">
                  {exp.positions.map((pos) => {
                    const ExperienceIcon = iconMap[pos.icon || 'business'];
                    return (
                      <div key={pos.id} className="space-y-6 flex-1 flex flex-col justify-between">
                        <div>
                          ...
                          <div className="flex items-center gap-3 border-b border-dashed border-neutral-200 dark:border-neutral-800 pb-4">
                            <div className="flex size-14 shrink-0 items-center justify-center rounded-none text-primary">
                              <ExperienceIcon className="size-16" />
                            </div>
                            <div>
